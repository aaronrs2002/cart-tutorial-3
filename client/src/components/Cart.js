...
const Cart = (props) => {
    ...
    const items = [
        ...
        { itemName: "butter", price: 2.45 },
        { itemName: "yogurt", price: 3.99 },
        { itemName: "cottage cheese", price: 4.90 },
        { itemName: "comb", price: 1.99 },
        { itemName: "sun glasses", price: 8.99 }
    ];
    ...
    const submitCart = () => {
        ...
        const user = "aaron@web-presence.biz";
        let currentCart = [];
